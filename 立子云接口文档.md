...
## 2.4 API准则四
	rest接口说明：在错误情况下，quarkioe将返回标准的HTTP响应代码，如RFC2616(http://www.w3.org/Protocols/rfc2616/rfc2616-sec10.html)中所述。客户端不仅应该能够处理个人代码，而且还能处理代码类别（例如，4xx）。响应主体会包含有关错误的更多信息，请参阅下面的错误媒体类型定义。一般错误解释是：
